...
@interface FenLeiViewController ()<UIScrollViewDelegate,selectIndexPathDelegate>
...
@property (nonatomic ,strong) NSMutableArray * hid;
...
{
    if (!_hid) {
        _hid = [[NSMutableArray alloc]init];
    }
    return  _hid;
}
...
- (void)selectIndexPathRow:(NSInteger)index
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"fenleishuaxin" object:self.ftime];
