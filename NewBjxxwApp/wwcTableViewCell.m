...
@implementation wwcTableViewCell
...
#warning 这是付款的那个界面!!!稍后要写的!!!!注意!!!!warning!!!!!
    ...
    NSLog(@"2");
    [[NSNotificationCenter defaultCenter] postNotificationName:@"wwwfukuan" object:nil];//未完成界面的付款
