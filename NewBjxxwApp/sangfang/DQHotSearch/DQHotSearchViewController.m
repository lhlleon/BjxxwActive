...
-(UITableView *)SearchTableView{
    if (!_SearchTableView) {
        _SearchTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, SYPMW, SYPMH-64) style:UITableViewStylePlain];
...
- (void)viewDidLoad {
    ...
    UIImageView * im = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"fh"]];
    im.frame = CGRectMake(0, 0, 20, 20);
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithCustomView:im];
    ...
    self.isChange = NO;
    self.BYsearchTextFd = [[DQTextFild alloc]initWithFrame:CGRectMake(50, 23,self.view.frame.size.width-100,31)];
...
- (void)loadingData{
    ...
    NSArray *array = @[@"赛车",@"奔驰",@"体育",@"踏青",@"银月湖",@"推荐内容",@"猜你喜欢"];
