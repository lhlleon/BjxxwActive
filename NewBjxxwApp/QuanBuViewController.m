...
@property (nonatomic,strong) NSString * hid;//活动id
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(fukuan:) name:@"fukuan" object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dianping:) name:@"dianping" object:nil];
...
//显示通知!
-(void)dianping:(NSNotification *)click
{
...
-(void)headerRereshing
{
    ...
    NSDictionary * dic = @{@"page":page,@"uid":self.uid,@"code_id":@"1"};
    NSLog(@"%@",self.uid);
